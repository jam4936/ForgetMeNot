...
export const DailySchedule = (patient : Patient) => {
        ...
        return (
            <div id={question.id.toString()} className={question.questionType}>
                ...
                <Select id={question.id.toString()} className={question.questionType}
                        defaultValue={findResponse(question)}
    ...
    const getSingleLine = (question: Question) => {
        return (
            <div id={question.id.toString()} className={question.questionType}>
                ...
                <TextField id={question.id.toString() + "_resp"} defaultValue={findResponse(question)}
